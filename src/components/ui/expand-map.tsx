      ...
      >
            ...
            >
              ...
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="drop-shadow-lg"
                  style={{ filter: "drop-shadow(0 0 10px rgba(243, 108, 33, 0.5))" }}>
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="#F36C21" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          <div className="flex items-start justify-between">
            <div className="relative">
              ...
              >
                <motion.svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  ...
                  animate={{
                    filter: isHovered
                      ? "drop-shadow(0 0 8px rgba(243, 108, 33, 0.6))"
                      : "drop-shadow(0 0 4px rgba(243, 108, 33, 0.3))",
                  }}
                  transition={{ duration: 0.3 }}
                >
            ...
            >
              <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#F36C21" }} />
              <span className="text-[10px] font-medium text-muted-foreground tracking-wide uppercase">Ubicación</span>
            </motion.div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <motion.div
              className="h-px"
              style={{ background: "linear-gradient(to right, rgba(243,108,33,0.5), rgba(243,108,33,0.3), transparent)" }}
